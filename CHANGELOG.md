...
* enhance admin user management with sorting, pagination, and users-per-page filtering ([73df9e5](https://github.com/AuthApex/authapex-hub/commit/73df9e5f8fb71a3abce597fc06dba6e45559a57b))


### Bug Fixes

* sync usersPerPage value with component state via useEffect ([0088229](https://github.com/AuthApex/authapex-hub/commit/0088229982498374409647122a14f84ecf151d8b))
